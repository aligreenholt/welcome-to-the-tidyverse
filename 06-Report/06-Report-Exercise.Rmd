...
There have been **`r n`** children named Ali. The name Ali was most popular in `r most$year`, when `r most$n` `r most_sex` were named Ali. Ali is traditionally a `r sex` name.

```{r echo=FALSE}
name_data %>% 
  ggplot() +
    geom_ribbon(mapping = aes(x = year, ymax = prop, fill = sex), ymin = 0, alpha = 0.5) +
    labs(title = "Popularity of the name Ali", 
         subtitle = "The proportion of boys and girls named Ali, 1880-2017", 
